...
#ifndef	__LIGHTNING_TREE_OLD_3D_H__
#define	__LIGHTNING_TREE_OLD_3D_H__
...
public :
	...
	LightningTreeNode()
		: m_iX( 0 ), m_iY( 0 ), m_iZ( 0 ), m_fXJittered( 0 ), m_fYJittered( 0 ), m_fZJittered( 0 ), m_bJittered( false )
...
public :
	...
	// add child node
	void	AddChild( int iParentX, int iParentY, int iParentZ, int iChildX, int iChildY, int iChildZ ) ;
...
#endif	// __LIGHTNING_TREE_OLD_3D_H__
