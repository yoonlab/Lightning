...
#ifndef	__LIGHTNING_TREE_H__
#define	__LIGHTNING_TREE_H__
...
public :
	...
	// add child node
	void	AddChild( int iParentX, int iParentY, int iChildX, int iChildY, bool bTarget = false ) ;
