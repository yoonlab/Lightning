...
public :
	...
	// load map
	bool	Load( const std::string& strPath ) ;																						// it only support single target or ground target
	bool	Load( LightningType eType, int iGridSize, int iClusteredGridSize, int sx, int sy, const std::vector< Pos >& vTargets ) ;	// it can be used for all types
